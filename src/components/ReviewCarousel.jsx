...
const testReviews = [
  ...
  {
    id: 3,
    text: "I truly like Gandalf, but I think that Frodo Baggins is simply a shitty character. Eventhough I didn't like Frodo, the movie was epic.",
    rating: 4,
    movie: "The Lord of the Rings: The Return of the King",
    user: "user@example.com",
    ...
    <div className="review-carousel">
      ...
      <div className="review-card">
        ...
        <div className="review-user">
          <img
            src={reactLogo} // Temporary img of React logo. This will be replaced with user profile pic
            alt="user avatar"
